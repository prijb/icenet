...
# Trigger filters
def filter_2022(X, isMC=None, class_id=None, xcorr_flow=False):
    """ Basic filters.
...
def filter_2023(X, isMC=None, class_id=None, xcorr_flow=False):
    """ Basic filters.
    ...
    names = ["O['L1_DoubleMu_15_7'] | "
             ...
             "O['L1_DoubleMu4p5_SQ_OS_dR_Max1p2'] | "
             "O['L1_DoubleMu4_SQ_OS_dR_Max1p2'] | "
             "O['L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4'] | "
             "O['L1_DoubleMu8_SQ']"
    ]
