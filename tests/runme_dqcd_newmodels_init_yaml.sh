...
# Training
python configs/dqcd/include/ymlgen_scouting.py --process 'QCD'       --filerange '[0-100]'      --outputfile configs/dqcd/include/QCD_new.yml
...
# Deployment
python configs/dqcd/include/ymlgen_scouting.py --process 'QCD'       --filerange '[101-100000]' --outputfile configs/dqcd/include/QCD_new_deploy.yml
